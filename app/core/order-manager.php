...
class OrderManager {
	...
	public function addOrder ( \Maven\Core\Domain\Order $order, $addStatus = true ) {
		...
		\Maven\Loggers\Logger::log()->message( 'Maven/OrderManager/addOrder: Updating billing contact ' );
		$this->updateProfile( $order->getBillingContact() );

		\Maven\Loggers\Logger::log()->message( 'Maven/OrderManager/addOrder: Updating shipping contact ' );
		$this->updateProfile( $order->getShippingContact() );

		\Maven\Loggers\Logger::log()->message( 'Maven/OrderManager/addOrder: Updating contact contact ' );

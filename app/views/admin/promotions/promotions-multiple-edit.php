	...
	<ng-form name="promotionForm">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<alert type="info">
					<p>
						<span>Here you can create similar promotions with diferent codes.</span></br>
						<span>Just set the quantity and configure your promotion. </span>
					</p>
				</alert>	
			</div>
		</div>
		...
		<div class="form-group" show-errors>
			...
			<div class="col-sm-6">
				<input type="text" only-digits class="form-control" required name="promotionQuantity"id="code" ng-model="promotion.quantity" />
				<p class="help-block" ng-if="promotionForm.promotionQuantity.$error.required ">The promotion's quantity is required</p>
			</div>
		</div>
		<div class="form-group" show-errors>
		...
		<div class="form-group" show-errors>
			...
			<div class="col-sm-6">
				...
				<p class="help-block" ng-if="promotionForm.promotionValue.$error.required">The promotion's type is required</p>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" only-digits readonly class="form-control" id="uses" ng-model="promotion.uses" />
			</div>
		</div>
		<div class="form-group" show-errors>

...
<div class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<input type="text" class="form-control" id="from" datepicker-popup="yyyy/MM/dd" ng-model="promotion.from" />			
		</div>
	</div>
	<div class="form-group">
		<label for="to" class="col-sm-2 control-label">To</label>
		<div class="col-sm-6">
			<input type="text" class="form-control" id="to" datepicker-popup="yyyy/MM/dd" ng-model="promotion.to" />
		</div>
	</div>
	<div class="form-group">

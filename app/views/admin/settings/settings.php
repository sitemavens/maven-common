                    ...
                    <div class="col-md-4">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group"  >
                                    <label for="useGravityFormTemplate">Disable Maven Template on GF submissions</label>						
                                    <input type="checkbox" class="form-control" ng-model="setting.useGravityFormTemplate" name="useGravityFormTemplate" />
                                </div>
                            </div>
                        </div>
                    </div>

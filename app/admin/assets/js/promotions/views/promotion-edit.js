...
define(['jquery', 'localization', 'notifications', 'spinner', 'text!templates/promotion-edit.html', 'toggleButtons', 'wysihtml5', 'datePicker'],
	function($, localization, notifications, spinner, PromotionTemplate) {

		return  Backbone.View.extend({
			template: _.template(PromotionTemplate),
			//countries:null,
			initialize: function(options) {
				_.bindAll(this, 'savePresenter', 'cancelPresenter', 'typeChanged', 'sectionChanged');
				if (!this.model.id) {
					spinner.stop();
				}
			...
			events: {
				'click #save': 'savePresenter',
				'click #cancel': 'cancelPresenter'
			},

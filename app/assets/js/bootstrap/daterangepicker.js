...
!function ($) {
	...
	var DateRangePicker = function (element, options, cb) {
		...
		var DRPTemplate = '<div class="mavenTheme daterangepicker dropdown-menu">' +
	...
	DateRangePicker.prototype = {
		...
		enterRange: function (e) {
			...
			if (label == this.locale.customRangeLabel) {
				...
				var start= (dates[0]==null?'N/A':dates[0].toString(this.format));
				this.container.find('input[name=daterangepicker_start]').val(start);
				
				var end= (dates[1]==null?'N/A':dates[1].toString(this.format));
